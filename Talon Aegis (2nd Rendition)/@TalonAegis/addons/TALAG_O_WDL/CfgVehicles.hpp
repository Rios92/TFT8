// Copy this part to your CfgVehicles config. Switch the Arma 3 vanilla boxes for CUP ones if necessary (replace all instances).
    ...
    class TALAG_O_WDL_AmmoBox : Box_East_Ammo_F {
    ...
    class TALAG_O_WDL_WeaponsBox : Box_East_Wps_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_O_WDL_LaunchersBox : Box_East_WpsLaunch_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_O_WDL_UniformBox : Box_East_Uniforms_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_O_WDL_SupportBox : Box_East_Support_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_O_WDL_SupplyBox : O_SupplyCrate_F {
        author = WOC Rios [TFT8];
...
[ALIVE_factionDefaultSupplies, "TALAG_O_WDL", ["TALAG_O_WDL_AmmoBox","TALAG_O_WDL_WeaponsBox","TALAG_O_WDL_LaunchersBox","TALAG_O_WDL_UniformBox","TALAG_O_WDL_SupportBox","TALAG_O_WDL_SupplyBox"]] call ALIVE_fnc_hashSet;