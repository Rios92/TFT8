// Copy this part to your CfgVehicles config. Switch the Arma 3 vanilla boxes for CUP ones if necessary (replace all instances).
    ...
    class TALAG_I_WDL_AmmoBox : Box_East_Ammo_F {
    ...
    class TALAG_I_WDL_WeaponsBox : Box_East_Wps_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_I_WDL_LaunchersBox : Box_East_WpsLaunch_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_I_WDL_UniformBox : Box_East_Uniforms_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_I_WDL_SupportBox : Box_East_Support_F {
        author = WOC Rios [TFT8];
    ...
    class TALAG_I_WDL_SupplyBox : O_SupplyCrate_F {
        author = WOC Rios [TFT8];
...
[ALIVE_factionDefaultSupplies, "TALAG_I_WDL", ["TALAG_I_WDL_AmmoBox","TALAG_I_WDL_WeaponsBox","TALAG_I_WDL_LaunchersBox","TALAG_I_WDL_UniformBox","TALAG_I_WDL_SupportBox","TALAG_I_WDL_SupplyBox"]] call ALIVE_fnc_hashSet;